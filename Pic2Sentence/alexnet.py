...
def alex_net(inputs, targets=None):
    ################################################################################
    ...
    # fc8
    # fc(1000, relu=False, name='fc8')
    # fc8W = tf.get_variable("fc8W", initializer=net_data["fc8"][0])
    # fc8b = tf.get_variable("fc8b", initializer=net_data["fc8"][1])
    ...
    tf.image_summary("image", conv1_image)
    tf.image_summary("image1layer", feature_map_1)
    # prob
    # softmax(name='prob'))
    alex_var_list = [conv1W, conv1b, conv2W, conv2b, conv3W, conv3b, conv4W, conv4b,
                     conv5W, conv5b, fc6W, fc6b, fc7W, fc7b]
    # prob = tf.nn.softmax(fc8)
    # init = tf.initialize_all_variables()
    saver_alex = tf.train.Saver(alex_var_list)
    # merged_summary = tf.merge_all_summaries()
    return fc7,saver_alex